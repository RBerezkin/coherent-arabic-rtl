...
// Brackets
defineProperty(RTLChar, "brackets", "{}()");
// Harakat
defineProperty(RTLChar, "harakat", "ًٌٍَُِّْْ");
// Sybmols
defineProperty(RTLChar, "symbols", "ًٌٍَُِّـ.،؟ @#$%^&*-+|/=~(){}ْ,");
// Alef chars
defineProperty(RTLChar, "alefChars", "آأإا");

export default RTLChar;
